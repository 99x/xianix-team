#!/usr/bin/env bash
# run-security-review-test-ado.sh
# Quick smoke-test driver for security review on Azure DevOps PRs. Loads credentials
# from .env, then delegates to run-security-review.sh with PLATFORM=azure-devops.
set -euo pipefail
